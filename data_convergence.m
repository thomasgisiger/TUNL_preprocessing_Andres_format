...
%         pause
        ...
        for trial=1:ntrials
            ...
            if contains(fol,'2 SEC','IgnoreCase',true)
                delay = 2;
            elseif contains(fol,'4 SEC','IgnoreCase',true)
                delay = 4;
            elseif contains(fol,'6 SEC','IgnoreCase',true)
                delay = 6;
            else
               disp('Incapable to read the delay duration...')
               pause
            end
